        ...
        <input type="hidden" name="customer" value="${sessionScope.id}">
          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <input type="text" required="" class="form-control border-0 bg-smoke" name="matchTitle" value=${match.matchTitle}>
              </div>
          
            <div class="col-lg-6">
              <div class="form-group">
                <label for="inputName">희망하는 인원수</label>
                <input type="number"  name="matchPeopleNum" class="form-control border-0 bg-smoke" value=${match.matchPeopleNum}>
              </div>
            </div>
    ...
    <!-- 날짜 선택  끝 -->       	
    	...
    	<div class="accordion" id="accordionOne">
          ...
          <div class="form-group mb-5">
            ...
            <textarea class="form-control border-0 bg-smoke" rows="10" name="matchContent">${requestScope.match.matchContent}</textarea>
          </div>
          </div>
